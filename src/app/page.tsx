  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30 pb-32">
      ...
      <nav className="fixed top-0 w-full z-50 glass-dark border-b border-border py-4 px-6 flex justify-between items-center">
        ...
        <Link href="/chat" className="bg-primary text-white py-2 px-5 rounded-xl hover:bg-accent transition-all text-xs font-black uppercase tracking-widest shadow-lg shadow-primary/20 flex items-center gap-2">
      ...
      <section className="text-center px-6">
        ...
        >
          ...
          <Link href="/chat" className="inline-flex items-center gap-4 bg-primary text-white py-4 px-10 rounded-2xl hover:bg-accent transition-all font-black uppercase text-sm tracking-widest shadow-2xl shadow-primary/30 active:scale-95 group">
